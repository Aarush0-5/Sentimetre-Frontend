                ...
                return (
                    ...
                    {selectedPodcast && (
                        ...
                        <div className="bg-white p-5 rounded-lg max-w-lg w-full text-left">
                            ...
                            ></div>
                            <h2 className={`border-2 border-black flex bg-brown-200 text-l ${textColors[podcast.pbg]} justify-center w-full mb-2`}>
                            {selectedPodcast.ptitle}
                            </h2>
                            <p className={`overflow-hidden overflow-wrap border-2 border-black flex bg-brown-200 text-l ${textColors[podcast.pbg]}  justify-center p-4 w-full`}>
                    ...
                    <div key={podcast._id} className="flex flex-col p-2 w-full h-full ml-0 lg:ml-10 mr-0 lg:mr-3">
                        ...
                        <p
                            ...
                            className={`flex text-2xl ${podcast.pbg} w-full p-2 cursor-pointer font-bold underline`}
                        >
                            {podcast.ptitle}
                        </p>
                        <p
                            className={`flex ${podcast.pbg} w-full text-xl p-2`}
                        >
